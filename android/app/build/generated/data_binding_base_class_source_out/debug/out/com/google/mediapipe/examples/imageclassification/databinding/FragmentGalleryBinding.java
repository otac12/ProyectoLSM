...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  private FragmentGalleryBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull ContentLoadingProgressBar progress, @NonNull RecyclerView recyclerviewResults,
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGalleryBinding((CoordinatorLayout) rootView, binding_bottomSheetLayout,
          fabGetContent, imageResult, progress, recyclerviewResults, tvPlaceholder, videoView);
    }
