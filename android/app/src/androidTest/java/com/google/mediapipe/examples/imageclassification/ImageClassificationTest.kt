...
class ImageClassificationTest {
    ...
    private val expectedCategoriesForImageAndLiveStreamMode = listOf(
        Category.create(0.1f, 0, "Letra_A_Derecha", ""),
        Category.create(0.1f, 1, "Letra_C_Derecha", "")
    )

    private val expectedCategoryForVideoMode = listOf(
        Category.create(0.1f, 0, "Letra_Y_Derecha", ""),
        Category.create(0.1f, 1, "Letra_O_Derecha", "")
    )
